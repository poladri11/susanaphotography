<main class="main__edit-gal">
    <form method="POST" enctype="multipart/form-data">
        <div class="main__edit-gal-head">
            <div class="main__edit-gal-head-acont">
                <a class="main__edit-gal-head-back" href="/admin/galeria">Volver</a>
                <a class="main__edit-gal-head-back" style="background-color: #6e0000;" href="/admin/galeria/remove?id=<?php echo $galeriaDats['id'] ?>">Eliminar categoría</a>
            </div>
        ...
        <div class="main__edit-gal-body">
            ...
            <div class="main__edit-gal-body-images-cont">
                ...
                <?php foreach($fotosCat as $foto) { ?>

                    <div class="main__edit-gal-body-images-div">
                        <input type="checkbox" name="imgRemoveCats[]" id="imgRemoveCats[]" class="checkboxRemoveFotoCat" value="<?php echo $foto['pathFoto'] ?>">
                        ...
                        <img src="<?php echo $foto['pathFoto'] ?>" alt="Foto halloween">
                    </div>
